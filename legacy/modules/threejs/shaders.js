...
void main( void ) {
	...
	//Scaling by 256/10 just happens to give a good value for the alphaFactor slider.
	...
	for(int i = 0; i < MAX_STEPS; i++)
	{
		...
		alphaSample = colorSample.a * alphaFactor;
...
export default { 
	vertexShaderFirstPass: vertexShaderFirstPass, 
	fragmentShaderFirstPass: fragmentShaderFirstPass,
	vertexShaderSecondPass: vertexShaderSecondPass,
	fragmentShaderSecondPass: fragmentShaderSecondPass
}